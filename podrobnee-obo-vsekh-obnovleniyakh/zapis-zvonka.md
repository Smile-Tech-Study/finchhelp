...
Для этого в звонок добавлена кнопка для старта записи звонка, она доступна только преподавателям.

![](./zapis-zvonka.png){width=652px height=281px}

После того, как началась запись иконка записи у преподавателя сменится на “Остановить запись”, а у прочих участников звонка появится информационное окно о том, что ведется запись.
